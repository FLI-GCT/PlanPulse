...
export type OfNodeData = GraphNode & {
  margin: MarginResult | undefined;
  estCritique: boolean;
};

type OfNodeType = Node<OfNodeData, 'ofNode'>;
...
function OfNodeComponent({ data, id }: NodeProps<OfNodeType>) {
...
export const OfNode = memo(OfNodeComponent);
